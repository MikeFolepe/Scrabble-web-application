...
describe('WaitingRoomComponent', () => {
    ...
    it('should redirect to home page if the Owner name is empty', () => {
        ...
        component['gameSettingsService'].gameSettings = new GameSettings(['', ''], 1, '01', '00', 'Débutant', 'Activer', 'francais', '');
    ...
    it('should not redirect to home page if the Owner name is not empty', () => {
        ...
        component['gameSettingsService'].gameSettings = new GameSettings(['Mike', ''], 1, '01', '00', 'Débutant', 'Activer', 'francais', '');
        component.handleReloadErrors();
    ...
    it('should route the user a the view on init', () => {
        jasmine.clock().install();
        component['gameSettingsService'].gameSettings = new GameSettings(['Mike', ''], 1, '01', '00', 'Débutant', 'Activer', 'null', '');

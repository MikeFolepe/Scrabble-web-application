...
fdescribe('PlayerAIService', () => {
    ...
    it('should place word on board horizontally', () => {
        const word = { word: 'MAJID', orientation: Orientation.HorizontalOrientation, line: 5, startIdx: 0, point: 0 };
    ...
    it('should place word on board vertically', () => {
        const word = { word: 'MAJID', orientation: Orientation.VerticalOrientation, line: 5, startIdx: 0, point: 0 };
        const expected = JSON.parse(JSON.stringify(scrabbleBoard));
        expected[5][0] = 'M';
        expected[6][0] = 'A';
        expected[7][0] = 'J';
    ...
    it('should sort words by points rewards', () => {
        const word8: PossibleWords = { word: 'mare', orientation: Orientation.VerticalOrientation, line: 0, startIdx: 0, point: 2 };
        const word1: PossibleWords = { word: 'amar', orientation: Orientation.HorizontalOrientation, line: 0, startIdx: 0, point: 15 };
        const word2: PossibleWords = { word: 'maree', orientation: Orientation.HorizontalOrientation, line: 0, startIdx: 0, point: 15 };
        const word3: PossibleWords = { word: 'martin', orientation: Orientation.HorizontalOrientation, line: 0, startIdx: 0, point: 3 };
        const word4: PossibleWords = { word: 'mare', orientation: Orientation.HorizontalOrientation, line: 0, startIdx: 0, point: 4 };

        const word5: PossibleWords = { word: 'amar', orientation: Orientation.VerticalOrientation, line: 0, startIdx: 0, point: 8 };
        const word6: PossibleWords = { word: 'maree', orientation: Orientation.VerticalOrientation, line: 0, startIdx: 0, point: 8 };
        const word7: PossibleWords = { word: 'martin', orientation: Orientation.VerticalOrientation, line: 0, startIdx: 0, point: 3 };
    ...
    it('should remove words not matching the pointing range', () => {
        const word6: PossibleWords = { word: 'maree', orientation: Orientation.VerticalOrientation, line: 0, startIdx: 0, point: 8 };
        const word7: PossibleWords = { word: 'martin', orientation: Orientation.VerticalOrientation, line: 0, startIdx: 0, point: 9 };
        const word8: PossibleWords = { word: 'mare', orientation: Orientation.VerticalOrientation, line: 0, startIdx: 0, point: 10 };
        const word1: PossibleWords = { word: 'amar', orientation: Orientation.HorizontalOrientation, line: 0, startIdx: 0, point: 3 };
        const word3: PossibleWords = { word: 'martin', orientation: Orientation.HorizontalOrientation, line: 0, startIdx: 0, point: 5 };
        const word4: PossibleWords = { word: 'mare', orientation: Orientation.HorizontalOrientation, line: 0, startIdx: 0, point: 6 };
        const word2: PossibleWords = { word: 'maree', orientation: Orientation.HorizontalOrientation, line: 0, startIdx: 0, point: 4 };

        const word5: PossibleWords = { word: 'amar', orientation: Orientation.VerticalOrientation, line: 0, startIdx: 0, point: 6 };

...
fdescribe('Place Letter', () => {
    ...
    it('should play from the center at first round', () => {
        ...
        const spyOnPlace = spyOn<any>(playerAiService, 'place'); /* .and.returnValue(true)*/

        const word1: PossibleWords = { word: 'on', orientation: Orientation.HorizontalOrientation, line: 7, startIdx: 7, point: 2 };
        const word2: PossibleWords = { word: 'on', orientation: Orientation.VerticalOrientation, line: 7, startIdx: 7, point: 2 };
    ...
    it('should play alternatives when no matching pointing possibilities', () => {
        const allPossibleWords: PossibleWords[] = [{ word: 'ton', orientation: Orientation.VerticalOrientation, line: 3, startIdx: 3, point: 0 }];

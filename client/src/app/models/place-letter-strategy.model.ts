...
export class PlaceLetters extends PlayStrategy {
    ...
    private choosePossibility(possibleWord: string[], context: PlayerIAComponent, startPos: Vec2) {
        ...
        priorityPoss = this.find(possibleWord, startPos, orientationPos, context.placeLetterService.scrabbleBoard, randomPointing).priorityPoss;
        altPoss = this.find(possibleWord, startPos, orientationPos, context.placeLetterService.scrabbleBoard, randomPointing).altPoss;
